...
✔︎ Ext : Search
✔︎ ID : ${anu.videoId}
✔︎ Duration : ${anu.timestamp}
✔︎ Viewers : ${anu.views}
✔︎ Upload At : ${anu.ago}
✔︎ Author : ${anu.author.name}
✔︎ Channel : ${anu.author.url}
✔︎ Description : ${anu.description}
✔︎ Url : ${anu.url}`,
                    footer: hinata.user.name,
                    buttons: buttons,
                    headerType: 4
	    ...
	    case 'ytmp3': case 'ytaudio': {
                ...
                hinata.sendImage(m.chat, media.thumb, `✔︎ Title : ${media.title}\n✔︎ File Size : ${media.filesizeF}\n✔︎ Url : ${isUrl(text)}\n✔︎ Ext : MP3\n✔︎ Resolusi : ${args[1] || '128kbps'}`, m)
            ...
            case 'ytmp4': case 'ytvideo': {
                ...
                if (media.filesize >= 100000) return m.reply('File Melebihi Batas '+util.format(media))
                hinata.sendMessage(m.chat, { video: { url: media.dl_link }, mimetype: 'video/mp4', fileName: `${media.title}.mp4`, caption: `✔︎ Title : ${media.title}\n✔︎ File Size : ${media.filesizeF}\n✔︎ Url : ${isUrl(text)}\n✔︎ Ext : MP3\n✔︎ Resolusi : ${args[1] || '360p'}` }, { quoted: m })
            }
            break
	    case 'getmusic': {
                let { yta } = require('./lib/y2mate')
		...
		let { pinterest } = require('./lib/scraper')
                ...
                hinata.sendMessage(m.chat, { image: { url: result }, caption: '✔︎ Media Url : '+result }, { quoted: m })
            }
            break
	    case 'couple': {
                m.reply(mess.wait)
		...
		let buttons = [
                ...
                let buttonMessage = {
                    ...
                    caption: `✔︎ Title : ${result.title}\n✔︎ Category : ${result.type}\n✔︎ Detail : ${result.source}\n✔︎ Media Url : ${result.image[2] || result.image[1] || result.image[0]}`,
                    footer: hinata.user.name,
                    buttons: buttons,
                    headerType: 4
                }
		...
		let { wikimedia } = require('./lib/scraper')
                ...
                let buttonMessage = {
                    ...
                    caption: `✔︎ Title : ${result.title}\n✔︎ Source : ${result.source}\n✔︎ Media Url : ${result.image}`,
                    footer: hinata.user.name,
                    buttons: buttons,
                    headerType: 4
                }
		...
		let { quotesAnime } = require('./lib/scraper')
            ...
            case 'artimimpi': case 'tafsirmimpi': {
                ...
                hinata.sendText(m.chat, `✔︎ *Mimpi :* ${anu.message.mimpi}\n✔︎ *Arti :* ${anu.message.arti}\n✔︎ *Solusi :* ${anu.message.solusi}`, m)
            }
            break
            case 'ramalanjodoh': case 'ramaljodoh': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendText(m.chat, `✔︎ *Nama Anda :* ${anu.message.nama_anda.nama}\n✔︎ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n✔︎ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n✔︎ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n✔︎ *Hasil :* ${anu.message.result}\n✔︎ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'ramalancinta': case 'ramalcinta': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendText(m.chat, `✔︎ *Nama Anda :* ${anu.message.nama_anda.nama}\n✔︎ *Lahir Anda :* ${anu.message.nama_anda.tgl_lahir}\n✔︎ *Nama Pasangan :* ${anu.message.nama_pasangan.nama}\n✔︎ *Lahir Pasangan :* ${anu.message.nama_pasangan.tgl_lahir}\n✔︎ *Sisi Positif :* ${anu.message.sisi_positif}\n✔︎ *Sisi Negatif :* ${anu.message.sisi_negatif}\n✔︎ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'artinama': {
                if (!text) throw `Example : ${prefix + command} Riy`
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendText(m.chat, `✔︎ *Nama :* ${anu.message.nama}\n✔︎ *Arti :* ${anu.message.arti}\n✔︎ *Catatan :* ${anu.message.catatan}`, m)
            }
            break
            case 'kecocokannama': case 'cocoknama': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendText(m.chat, `✔︎ *Nama :* ${anu.message.nama}\n✔︎ *Lahir :* ${anu.message.tgl_lahir}\n✔︎ *Life Path :* ${anu.message.life_path}\n✔︎ *Destiny :* ${anu.message.destiny}\n✔︎ *Destiny Desire :* ${anu.message.destiny_desire}\n✔︎ *Personality :* ${anu.message.personality}\n✔︎ *Persentase :* ${anu.message.persentase_kecocokan}`, m)
            }
            break
            case 'kecocokanpasangan': case 'cocokpasangan': case 'pasangan': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendImage(m.chat,  anu.message.gambar, `✔︎ *Nama Anda :* ${anu.message.nama_anda}\n✔︎ *Nama Pasangan :* ${anu.message.nama_pasangan}\n✔︎ *Sisi Positif :* ${anu.message.sisi_positif}\n✔︎ *Sisi Negatif :* ${anu.message.sisi_negatif}`, m)
            }
            break
            case 'jadianpernikahan': case 'jadiannikah': {
                ...
                if (anu.status == false) return m.reply(anu.message)
                hinata.sendText(m.chat, `✔︎ *Tanggal Pernikahan :* ${anu.message.tanggal}\n✔︎ *karakteristik :* ${anu.message.karakteristik}`, m)
            }
            break
...
`,
		    ...
		    anu.media.map(async (url) => {
		        hinata.sendMessage(m.chat, { image: { url }, caption: `✔︎ Title : ${anu.title}\n✔︎ Author : ${anu.author.name}\n✔︎ Like : ${anu.like}\n✔︎ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
